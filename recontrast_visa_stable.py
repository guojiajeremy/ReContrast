    ...
    for epoch in range(int(np.ceil(total_iters / len(train_dataloader)))):
        ...
        for img, label in train_dataloader:
            ...
            if (it + 1) % 500 == 0:
                ...
                # model.train(encoder_bn_train=_class_ not in ['cashew', 'macaroni2', 'pcb1'])
                model.train(encoder_bn_train=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_name', type=str,
                        default='recontrast_visa_it3k_adam2e31e5_wd1e5_eps10_1rs5h_rs100_hm1d02_pn5e41e6_s111')
    args = parser.parse_args()

    item_list = ['candle', 'capsules', 'cashew', 'chewinggum', 'fryum', 'macaroni1', 'macaroni2',
                 'pcb1', 'pcb2', 'pcb3', 'pcb4', 'pipe_fryum']
    # item_list = ['cashew', 'pcb1']
